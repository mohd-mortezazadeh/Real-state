...
const path = [
    {
        name: "برترین دفاتر املاک",
        url: "/best-realtor"
    }
];


const BestAdvisors: NextPage = ({best_realtors}: any) => {
    ...
    return (
        <MainLayout hasBanner={false}>
            ...
            <Breadcrumb title={"دفاتر املاک برتر"} subtitle={""} path={path}/>
...
export const getServerSideProps: GetServerSideProps = async (context) => {
    ...
    const res = await axios.get(`https://api.villaarzan.com/best-realtor?${query}`)


    return {
        props: {
            best_realtors: JSON.parse(JSON.stringify(res?.data?.best_realtor)),
